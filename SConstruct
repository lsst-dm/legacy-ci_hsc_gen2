...
preWarp = command("warp", skymap,
                  ...
                  " -c recalibrate.doApplyExternalPhotoCalib=False -c recalibrate.doApplyExternalSkyWcs=False")
...
def processCoadds(filterName, dataList):
    ...
    warps = [command("warp-%d" % exp,
                     ...
                     [getExecutable("pipe_tasks", "makeCoaddTempExp.py") + " " + PROC + " " + ident +
                      ...
                      " -c recalibrate.doApplyExternalPhotoCalib=False" +
                      " -c recalibrate.doApplyExternalSkyWcs=False",
